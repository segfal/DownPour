...
QueueFamilyIndices DownPour::findQueueFamilies(VkPhysicalDevice device) {
...
void DownPour::pickPhysicalDevice() {
...
void DownPour::createLogicalDevice() {
...
SwapChainSupportDetails DownPour::querySwapChainSupport(VkPhysicalDevice device) {
...
VkSurfaceFormatKHR DownPour::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR DownPour::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D DownPour::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
