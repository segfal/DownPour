            ...
            if (primitive.material >= 0) {
                ...
                if (material.pbrMetallicRoughness.baseColorTexture.index >= 0) {
                    ...
                    if (!image.image.empty() && image.width > 0 && image.height > 0) {
                        ...
                        std::cout << "Warning: Texture image data is invalid or empty" << std::endl;
...
void Model::createTextureImageView(VkDevice device) {
...
void Model::createTextureSampler(VkDevice device) {
